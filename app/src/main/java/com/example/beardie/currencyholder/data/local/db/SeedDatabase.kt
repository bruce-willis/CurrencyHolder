...
object SeedDatabase {
    ...
    var category = arrayOf(
            Category(1, "Зарплата", TypeCategoryEnum.INCOME, Color.GREEN),
            Category(2, "Стипендия", TypeCategoryEnum.INCOME, Color.GREEN),
            Category(3, "Коммунальные платежи", TypeCategoryEnum.OUTGO, Color.RED),
            Category(4, "Одежда", TypeCategoryEnum.OUTGO, Color.RED),
            Category(5, "Питание", TypeCategoryEnum.OUTGO, Color.RED),
            Category(6, "Развлечения", TypeCategoryEnum.OUTGO, Color.RED),
            Category(7, "Другое", TypeCategoryEnum.OUTGO, Color.RED)
    )
